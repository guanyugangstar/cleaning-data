...
def format_sample_for_llm(df: pd.DataFrame) -> str:
...
        lines.append(f"- {col} ({dtype}), 唯一值数: {unique_count}, 样本: {sample}")
...
主动读取**提示词模板：** [reference/prompt_generate_config.md](reference/prompt_generate_config.md)
...
主动读取**提示词模板：** [reference/prompt_eda_analysis.md](reference/prompt_eda_analysis.md)
